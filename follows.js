(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'ze7dnwr61RwoAmEeRYNuP7hGmwZFUybfjHDwycxmgEFf1l0U', // Unique master Xively API key to be used as a default
							...
							xively.datastream.history(feedId, datastream.id, {duration: duration, interval: interval, limit: 1000}, function(datastreamData) {
								...
								if(datastreamData.datapoints) {
									...
									var graph = new Rickshaw.Graph( {
									    element: document.querySelector('#chart-' + feedId + '-' + datastream.id),
										width: 600,
										height: 200,
										renderer: 'bar',
